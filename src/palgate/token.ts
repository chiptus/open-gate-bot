...
function aesEncryptDecrypt(stateBytes: Uint8Array, keyBytes: Uint8Array, isEncrypt: boolean): Uint8Array {
...
function _aesEncDec(state: Uint8Array, key: Uint8Array, encrypt: boolean): void {
  if (encrypt) {
...
function step2(step1Result: Uint8Array, timestampSec: number, offset: number): Uint8Array {
